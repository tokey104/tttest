...
You can download the compendium as a zip from from this URL: <https://github.com/tokey104/tttest/archive/master.zip>

Or you can install this compendium as an R package, tttest, from GitHub with:
